...
import { Code, Palette, Server, Database, Figma, GitBranch, Wrench, Rocket, Brain, Shield } from 'lucide-react';
  ...
  const skillsData = [
    {
      ...
      color: 'cyan',
      skills: ['PyTorch', 'Python', 'NumPy', 'Pandas', 'Scikit-learn', 'sentence-transformers', 'HuggingFace', 'NLP']
    },
    {
    ...
    },
    {
      ...
      color: 'pink',
      skills: ['React.js', 'Next.js', 'Redux', 'HTML5', 'CSS3', 'TailwindCSS', 'Bootstrap']
    },
    {
      title: 'Backend Development',
      icon: <Server className="w-6 h-6" />,
      color: 'green',
      skills: ['Node.js', 'Express.js', 'Django', 'FastAPI', 'REST APIs', 'Django REST Framework']
    },
    {
      title: 'Database',
      icon: <Database className="w-6 h-6" />,
      color: 'orange',
      skills: ['MongoDB', 'MySQL', 'PostgreSQL', 'Firebase Firestore', 'Supabase']
    },
    {
      title: 'Auth & Security',
      icon: <Shield className="w-6 h-6" />,
      color: 'blue',
      skills: ['JWT', 'bcrypt', 'OAuth', 'Clerk Auth']
    },
    {
    ...
    },
    {
      ...
      color: 'indigo',
      skills: ['Postman', 'Socket.io', 'SendGrid', 'Gemini API', 'Docker']
    },
    {
      title: 'Deployment & Hosting',
      icon: <Rocket className="w-6 h-6" />,
      color: 'violet',
      skills: ['Vercel', 'Render', 'HuggingFace Spaces', 'Google Cloud Run', 'Netlify']
    }
  ];
